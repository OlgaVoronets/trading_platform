...
from retail.views import TraderDetailUpgateDeleteView, TraderListCreateView, NetworkViewSet, ProductViewSet
...
urlpatterns = [
    ...
    path('trader/<int:pk>/', TraderDetailUpgateDeleteView.as_view(), name='trader_detail_update_delete'),
]
